...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    TextView txt1,txt2,txt3,txt4,txt5,txt6,wage,overTimeWage,hoursWorked,overTimeHours,totalWage;
    EditText Name, hours;
        ...
        public void onClick (View v){
            switch(v.getId()){
                ...
                case R.id.btn_Regular:
                    ...
                    g.settype(1);
                    m.finalScreen(g,txt1, Name, hours, btnRates, btnX, btnRegular, btnPartTime, btnProbational, rates, txt2, txt3, txt4, txt5, txt6, wage, overTimeWage, hoursWorked, overTimeHours, totalWage);
                    ;break;
